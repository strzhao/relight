...
每日视频自动化（每天北京时间 10:00 cron 跑 video-discovery 做主题发现——旅行 / 人物成长线；命中主题才 spawn `claude -p` 调 memory-video skill 生成 1080p vlog，落盘 + 写 videos/videoUsages 表 + 企业微信推送封面与详情链接；无主题静默跳过，质量优先、非每日必出）。

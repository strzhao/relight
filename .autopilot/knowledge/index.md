...
- [2026-09-12] honeydo 大图生成挂死 = macOS GPU 交互保护（Renderer 利用率判据+空闲窗口纪律）→ [video](domains/video.md)
- [2026-09-12] Remotion 冷启动 600s 级 + browser-executable 显式化 → [video](domains/video.md)
- [2026-09-12] 测试进程真实凭据污染生产 COS/VPS（setupFiles 空串占位模式）→ [testing](domains/testing.md)
